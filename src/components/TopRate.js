...
class TopRate extends Component {
    ...
    componentDidMount(){
        API.getMovie('top_rated').then(response => {
            this.setState({movies_top_rate: response.results});
        })
    }
    render() {
        return (
            <section className="p-0 gen-section-padding-2">
                <div className="container">
                    <div className="row">
                        <div className="col-xl-6 col-lg-6 col-md-6">
                            <h4 className="gen-heading-title">Top Rated</h4>
                        </div>
                    ...
                    <div className="row mt-3">
                        <div className="col-12">
                            <div className="gen-style-2">
                                ...
                                >
                                    {
                                        this.state.movies_top_rate.slice(0,10).map((movie, index) => {
                                            return(
